...
class NewListFormTest(unittest.TestCase):
    ...
    def test_save_creates_new_list_from_post_data_if_user_not_authenticated(
        ...
        '''test: save creates new list from post data if user not authenticated'''
    ...
    def test_save_creates_new_list_from_post_data_if_user_authenticated(
        ...
        '''test: save creates new list from post data if user authenticated'''
    ...
    def test_save_returns_new_list_object(self, mock_List_create_new):
        '''test: save returns new list object'''
        user = Mock(is_authenticated=True)
        form = NewListForm(data={'text': 'new item text'})
        form.is_valid()
